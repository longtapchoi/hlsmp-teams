...
public class LicenseManager {
   ...
   private final String PLUGIN_NAME = "DonutTeam";
   private final String PLUGIN_ID = "DonutTeam";
   ...
   private boolean validateWithAPI(String licenseKey, String serverId) {
      ...
      try {
         ...
         String jsonData = String.format("{\"license_key\":\"%s\",\"server_id\":\"%s\",\"plugin_id\":\"%s\"}", licenseKey, serverId, "DonutTeam");
